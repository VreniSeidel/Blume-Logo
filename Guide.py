...
class Guide():
    ...
    def guide(self):
        ...
        tk.Button(command=self.exitFun, text="Click to run", borderwidth=5, relief="groove", background="black", foreground="aqua").grid(row=7, column=1, padx=(15, 15), pady=(10, 10))
